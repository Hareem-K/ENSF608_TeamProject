...
-- Venues table ready with IDs 1–11.

INSERT INTO Venues (v_name, v_kind, v_address, v_city, v_url)
VALUES
('Calgary Conference Center', 'in-person', '123 Main St', 'Calgary', NULL),
('Virtual Hub', 'virtual', NULL, NULL, 'https://virtualhub.com'),
('Art Gallery', 'in-person', '45 Art St', 'Calgary', NULL),
('Hybrid Learning Center', 'hybrid', '78 Edu Rd', 'Calgary', 'https://hybridedu.com'),
('Mountain Adventure Park', 'in-person', '99 Hill Rd', 'Calgary', NULL),
('Online Marketing Space', 'virtual', NULL, NULL, 'https://onlinemarketing.com'),
('Riverside Park', 'in-person', '200 River Rd', 'Calgary', NULL),
('Tech Online Arena', 'virtual', NULL, NULL, 'https://techarena.com'),
('Innovation Lab', 'in-person', '300 Lab St', 'Calgary', NULL),
('Community Center', 'in-person', '50 Community Dr', 'Calgary', NULL),
('Hybrid Expo Hall', 'hybrid', '88 Expo Rd', 'Calgary', 'https://hybridexpo.com');


-- Example 20–30 events
INSERT INTO Events (venue_id, user_id, e_title, e_description, e_capacity, e_ticket_price, e_is_ticketed, e_start_at, e_end_at)
VALUES
(1, 3, 'Tech Conference 2025', 'Annual technology conference in Calgary', 300, 99.99, TRUE, '2025-12-05 09:00:00', '2025-12-05 17:00:00'),
(2, 9, 'Virtual AI Workshop', 'Learn AI online from experts', 200, 49.99, TRUE, '2025-11-25 10:00:00', '2025-11-25 12:00:00'),
(3, 15, 'Art & Culture Expo', 'Explore local arts', 150, 0.00, FALSE, '2025-12-12 11:00:00', '2025-12-12 16:00:00'),
(4, 3, 'Hybrid Education Summit', 'Workshops & lectures both online and in-person', 400, 75.00, TRUE, '2025-12-20 09:00:00', '2025-12-20 17:00:00'),
(5, 9, 'Mountain Hiking Meetup', 'Join our outdoor adventure', 50, 0.00, FALSE, '2025-12-15 08:00:00', '2025-12-15 18:00:00'),
(6, 15, 'Online Marketing Bootcamp', 'Grow your online presence', 250, 59.99, TRUE, '2025-11-28 14:00:00', '2025-11-28 18:00:00'),
(7, 3, 'Riverside Music Fest', 'Live music along the river', 500, 120.00, TRUE, '2025-12-10 15:00:00', '2025-12-10 22:00:00'),
(8, 9, 'Tech Meetup Online', 'Networking & tech talks online', 100, 0.00, FALSE, '2025-11-30 18:00:00', '2025-11-30 20:00:00'),
